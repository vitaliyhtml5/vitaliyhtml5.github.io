...
function openOverlay(event, overlay,modal) {
	...
	localStorage.setItem('previous-result4', previousResult.innerText);
...
if (localStorage.getItem('previous-result4')) {
	previousResultRow.style.display = 'block';
	previousResult.innerText = localStorage.getItem('previous-result4');
}
else {
