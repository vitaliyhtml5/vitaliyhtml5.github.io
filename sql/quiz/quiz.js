...
function openOverlay(event, overlay,modal) {
	...
	localStorage.setItem('previous-result3', previousResult.innerText);
...
if (localStorage.getItem('previous-result3')) {
	previousResultRow.style.display = 'block';
	previousResult.innerText = localStorage.getItem('previous-result3');
}
else {
